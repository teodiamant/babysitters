...
export default function Profile() {
    ...
    return (
        <div className='profile'>
            ...
            <p>Address: {userProfile?.address}, {userProfile?.area} {userProfile?.postalCode}</p>
            <p>AMKA: {userProfile?.amka}</p>
            <p>Additional Information: {userProfile?.extraInfo}</p>
            {userProfile?.photoUrl && <img src={userProfile?.photoUrl} alt="Profile" />}
            <button onClick={handleLogout}>Logout</button>
